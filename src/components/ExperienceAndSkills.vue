<template>
    <section class="text-white mt-18" id="skills">
        ...
        <div class="py-8 px-4 xl:px-16">
            <h2 class="text-3xl font-bold text-white text-left mb-4">Mes
            ...
            <div data-aos="flip-letf">
                <h2 class="text-3xl font-bold text-white text-left mb-8 md:text-center md:mt-0 mt-8">Mes Expériences</h2>
                    ...
                    <div v-for="element in Experiences" :key="element.id">
                        <div class="flex items-center rounded-xl p-4 bg-[#111a3e] shadow-lg border border-[#1f1641]">
                            ...
                            <div class="w-3/4 pl-4">
                                <h3 class="text-2xl font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">{{ element.role }}</h3>
...
import { ref } from 'vue';
const Skills = ref([
    { id: 1, name: 'Php, Laravel', level: '70%' },
    { id: 2, name: 'JavaScript', level: '70%' },
    { id: 3, name: 'Python', level: '70%' },
    { id: 4, name: 'Mysql, MongoDB, Firebase', level: '70%' },
    { id: 5, name: 'Vue.js', level: '70%' },
    { id: 6, name: 'HTML, CSS, Tailwind CSS, Bootstrap', level: '70%' },
    { id: 7, name: 'NestJs, Flask', level: '40%' },
    { id: 8, name: 'NextJs, ReactJs', level: '40%' },
    { id: 9, name: 'React native, Flutter', level: '40%' }, 
]);
